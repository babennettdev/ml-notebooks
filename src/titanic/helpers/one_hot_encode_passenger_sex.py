...
def one_hot_encode_passenger_sex(
    *, 
    ...
    titanic_train_sex_dataframes = one_hot_encoder.fit_transform(titanic_dataframes["Sex"].values.reshape(-1, 1))
    ...
    titanic_dataframes= pd.concat([titanic_dataframes, titanic_train_sex_dataframes ], axis=1)
